namespace :foxtrove do
  ...
  task backfill_api_identifiers: :environment do
    ...
    ArtistUrl.enabled.where(api_identifier: nil, site_type: site_type).find_each do |artist_url|
  ...
  task update_e6_replaced_posts: :environment do
    ArtistUrl.enabled.where(site_type: "e621").find_each(&:update_e6_replaced)
  end
end
